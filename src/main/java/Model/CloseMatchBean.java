...
@ViewScoped
@Entity
public class CloseMatchBean implements Comparable<CloseMatchBean>, Serializable {
    ...
    private String author3Displayed;
    private String author3;
    private boolean author1Selected;
    private boolean author2Selected;
    private String uuid;

    public CloseMatchBean() {
    }

    public CloseMatchBean(String item1, String item2) {
        this.author1 = item1;
        this.author2 = item2;
...
//        System.out.println("disp2: "+author2Displayed);
    ...
    public String getAuthor3Displayed() {
        return author3Displayed;
    }

    public void setAuthor3Displayed(String author3Displayed) {
        this.author3Displayed = author3Displayed;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final CloseMatchBean other = (CloseMatchBean) obj;
    ...
    @Override
    public int compareTo(CloseMatchBean o) {
