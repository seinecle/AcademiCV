        ...
        float SKETCH_WIDTHf = 3200f;
        float SKETCH_HEIGTHf = 3200f;
        float SKETCH_CENTER_X = SKETCH_WIDTHf / 2;
        float SKETCH_CENTER_Y = SKETCH_HEIGTHf / 2;
        int SKETCH_WIDTH = 3200;
        int SKETCH_HEIGTH = 3200;
        ...
        //TEXT SIZE
        textSize(12+ (SKETCH_WIDTHf-600)/100);
...
//        background(BACKGROUND_COLOR, BACKGROUND_ALPHA);
        ...
        size(SKETCH_WIDTH, SKETCH_HEIGTH);
        smooth();
        noStroke();
        palette = new Colors();
...
//        println("number of segments (not counting the main one): "+nbSegments);
 ...
 //      println("radius Segment is: "+ radiusUnitSegment);
        ...
        //SEGMENT ITSELF
        fill(255, 0, 0);
        arc(SKETCH_WIDTH / 2f, SKETCH_HEIGTH / 2f, OUTER_CIRCLE_DIAMETER, OUTER_CIRCLE_DIAMETER, TWO_PI * (0.5f - radiusUnitAuthor / 2f), TWO_PI * (float) (0.5f + radiusUnitAuthor / 2f));
...
//            println("endArc: "+endArc);
            ...
            arc(SKETCH_WIDTH / 2, SKETCH_HEIGTH / 2, OUTER_CIRCLE_DIAMETER, OUTER_CIRCLE_DIAMETER,startArc,endArc);
...
//            println("accumulated count of total basic units treated so far: " + countBasicUnits);
        ...
        ellipse(SKETCH_WIDTH/2f,SKETCH_HEIGTH/2f,INNER_CIRCLE_DIAMETER,INNER_CIRCLE_DIAMETER);
